...
void loop()
{
  ...
  int hashX = constrain(antennaVal, 1, 200);
   hashX = int(map(antennaVal, 1, 200, 1, 18));
  ...
  if (QS == true){     //  A Heartbeat Was Found
      ...
      //hashY = constrain(IBI,0,1000);
      
      //hashY = IBI;
      //hashY = min(hashY, 1000);
      //hashY = int(map(hashY, 0, 1000, 200, 2000)); 
      
      vol = int(map(IBI, 0, 1000, 100, 25));
